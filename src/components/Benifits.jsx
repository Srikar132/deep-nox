  ...
  return (
    <Section id="features">
        <div className='container relative z-2'>
            <Heading className = "" 
            title = "DeepNox: Unmasking Deepfakes, Ensuring Digital Trust"
            />
                 ...
                 >
                  <div className='relative z-2 flex flex-col min-h-[22rem] p-[2.4rem] pointer-ecents-none'>
                    ...
                    <div className='flex items-center mt-auto'>
                      ...
                      <p className='ml-auto  font-code text-xs uppercase font-bold text-n-1 tracking-wider'>Explore More</p>
                      <Arrow />
                    </div>
                  </div>
