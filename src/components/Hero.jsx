        ...
        id="hero">
            <div className='container relative' ref={parallaxRef}>
                <div className='relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem]'>
                    ...
                    Explore the Possibilities of&nbsp;Deepfake Detection&nbsp;with {` `}
                         <span className='inline-block relative'>Deep<span className='text-5xl'>N</span>ox<img src={curve} width={624} height={28} className='absolute top-full left-0 w-full xl:-mt-2'/></span>
                    </h1>
                ...
                <div className='relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24'>
                    <div className='relative z-1 p-0.5 rounded-2xl bg-conic-gradient'>
                        <div className='relative bg-n-8 rounded-[1rem]'>
                            ...
                            <div className='aspect-[33/40] rounded-b-[0.9rem] md:aspect-[688/490] overflow-hidden lg:aspect-[1024/490]'>
